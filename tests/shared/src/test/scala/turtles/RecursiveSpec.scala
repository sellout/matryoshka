...
class RecursiveSpec extends TurtlesSuite {
  ...
  test("distPara should behave like para") {
    val v = mul(num(0), mul(num(0), num(1)))
  ...
  test("ghylo should behave like chrono with distHisto/distFutu") {
    forAll { (i: Int) =>
